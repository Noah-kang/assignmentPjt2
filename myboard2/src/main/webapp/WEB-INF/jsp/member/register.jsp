...
<body>
	<div class="register-container">
		...
		<form action="<c:url value='/member/register' />" method="post">
			<div>
				<label for="memberId">아이디 <span style="color: red;">*</span></label> <input
					type="text" id="memberId" name="memberId" placeholder="아이디를 입력해주세요"
					required>
			...
			<div class="buttons">
				<a href="<c:url value='/member/login' />" class="cancel">취소</a>
	...
	function validateForm(event) {
	    console.log("Validation started..."); // 폼 검증 시작 로그
